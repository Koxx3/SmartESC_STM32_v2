...
void VescToSTM_set_torque(int32_t current){
	...
	if(q >= 0){
		...
		MCI_ExecSpeedRamp(pMCI[M1], VescToSTM_erpm_to_speed(mc_conf.lo_min_erpm, mc_conf.si_motor_poles) , 0);
	}
