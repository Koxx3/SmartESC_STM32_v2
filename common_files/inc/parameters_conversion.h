...
#define OV_TEMPERATURE_THRESHOLD_d  ((V0_V + (dV_dT * (T0_C-OV_TEMPERATURE_THRESHOLD_C)))*INT_SUPPLY_VOLTAGE)
#define OV_TEMPERATURE_DEACT_d  ((V0_V + (dV_dT * (OV_TEMPERATURE_HYSTERESIS_C+T0_C-OV_TEMPERATURE_THRESHOLD_C)))*INT_SUPPLY_VOLTAGE)
